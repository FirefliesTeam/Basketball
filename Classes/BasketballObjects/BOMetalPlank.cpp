...
BMetalPlank::BMetalPlank(int cost, int priority, float scale): BPlank(cost, scale) {
...
BPlank* BMetalPlank::clone() {
    BPlank* plank = new BMetalPlank(_cost, _priority, _scale);
    return plank;
}